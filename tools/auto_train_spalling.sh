#!/bin/bash
# Sequential 2-GPU DDP training of the 3 spalling models.
# After each run, prune the periodic iter_*.pth (keep best_mIoU_*) to save disk.
set -u
cd /home/ldh/minkyung/mmsegmentation
...
for CFG in "${CONFIGS[@]}"; do
  ...
  echo "==================================================================="
  bash tools/dist_train.sh "$CFG" 2
  RC=$?
  if [ $RC -ne 0 ]; then
